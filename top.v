...
wire [5:0] count = (sw[0] == 1'b1) ? timer_count : stopwatch_count;
/******** UPDATE THIS SECTION ********/
...
wire en_stopwatch = (mode == 1'b0) && run;
wire en_timer     = (mode == 1'b1) && run;
...
// Mapping states to LEDs as per project requirements
assign led[8:3]   = stopwatch_count;
assign led[15:10] = timer_count;
assign led[0]     = mode; // Visual indicator of which mode is active
